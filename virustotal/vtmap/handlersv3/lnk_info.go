...
var vtToAzFeatLnkInfo = []bh.VtPathToAzFeature{
	bh.NewVtPathToAzFeat("creation_date", bh.VtTypeString, "creation_date", bh.AzFTDatetime, "lnkInfo - date in ISO8601 format."),
	bh.NewVtPathToAzFeat("access_date", bh.VtTypeString, "access_date", bh.AzFTDatetime, "lnkInfo - date in ISO8601 format."),
	bh.NewVtPathToAzFeat("modification_date", bh.VtTypeString, "modification_date", bh.AzFTDatetime, "lnkInfo - date in ISO8601 format."),
	bh.NewVtPathToAzFeat("link_flags", bh.VtTypeListOfStrings, "link_flags", bh.AzFTString, "lnkInfo - basic properties of the LNK file."),
	bh.NewVtPathToAzFeat("target_path", bh.VtTypeString, "target_path", bh.AzFTFilepath, "lnkInfo - (optional) target path from Link Target Identifier fields."),
	bh.NewVtPathToAzFeat("icon_location", bh.VtTypeString, "icon_location", bh.AzFTFilepath, "lnkInfo - (optional) path to the icon location."),
	...
	bh.NewVtPathToAzFeat("relative_path", bh.VtTypeString, "relative_path", bh.AzFTFilepath, "lnkInfo - (optional) target file relative path."),
	...
	bh.NewVtPathToAzFeat("local_path", bh.VtTypeString, "local_path", bh.AzFTFilepath, "lnkInfo - (optional)."),
	bh.NewVtPathToAzFeat("common_path", bh.VtTypeString, "common_path", bh.AzFTFilepath, "lnkInfo - (optional)."),
