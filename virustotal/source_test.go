...
func TestParseVTAndBuildSourceDroppingNonMaliciousFilesV3(t *testing.T) {
	...
	src, err := BuildSourceV3(vtmsg, &testAuthorSummary)
	require.Nil(t, err)
	require.Equal(t, (*events.EventSource)(nil), src)
}
